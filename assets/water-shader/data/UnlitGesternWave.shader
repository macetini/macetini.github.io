Shader "Custom/Unlit_GesternWave"
{
    ...
    {                
        ...
        _SSPower("Subsurface Scattering Power", Float) =  2
        _SSScale("Subsurface Scattering Scale", Range(0, 1)) =  0.5
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half3 SkyReflection(float3 worldPos, half3x3 tangentSpaceMatrix, half4 normalMapCoords)//, half2 uv)
            {
                ...
                return saturate(reflectedColor + glitter + subsurfaceScatter);
            }
